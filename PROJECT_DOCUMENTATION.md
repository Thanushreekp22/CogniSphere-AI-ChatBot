...
```bash
git clone https://github.com/Thanushreekp22/CogniSphere-AI-ChatBot.git
cd "CogniSphere AI"
```
...
**Repository:** [CogniSphere-AI-ChatBot](https://github.com/Thanushreekp22/CogniSphere-AI-ChatBot)
